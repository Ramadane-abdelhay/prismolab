...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Prismo Lab is the creative studio of Hamza Elmanssouri for branding, art direction, and digital presence." },
      { name: "author", content: "Prismo Lab" },
      { property: "og:title", content: "Prismo Lab | Turning Ideas Into Vision" },
      { property: "og:description", content: "Branding, art direction, and digital presence." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
    ],
    links: [
      { rel: "icon", type: "image/svg+xml", href: "/images/symbol-black.svg" },
      { rel: "shortcut icon", href: "/images/symbol-black.svg" },
