...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Who is Prismo? Meet Hamza Elmanssouri, the creative mind behind Prismo Lab." },
      { property: "og:title", content: "About | Prismo Lab" },
      { property: "og:description", content: "Meet Hamza Elmanssouri, the creative mind behind Prismo Lab." },
    ],
  }),
  component: About,
});
          ...
          <Reveal delay={0.15} className="lg:col-span-5">
            <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-white/[0.03] shadow-[0_30px_120px_rgba(0,0,0,0.45)]">
              ...
              <p className="absolute bottom-6 left-6 right-6 text-sm leading-relaxed text-foreground/80">
                Hamza Elmanssouri, the eye behind Prismo Lab, shaping ideas into identity, story, and atmosphere.
              </p>
            </div>
          </Reveal>
        </div>
